                ...
                {({ values, errors, touched, handleChange, handleSubmit }) => (
                    <section className="flex flex-col flex-grow bg-transparent w-11/12 mb-4">
                        ...
                        >
                            ...
                            <p className="text-gray-500 text-left font-normal">
                                You have the option of monthly or yearly
                                billing.
                            </p>
                            <p className="text-sm text-red-600 font-bold self-end">
                                {errors.plan_type &&
                                    touched.plan_type &&
                                    errors.plan_type}
                            </p>
                            ...
                            <label
                                htmlFor="arcade"
                                className="w-full p-3 rounded-md border border-solid border-gray-300 peer-checked/arcade:bg-purple-100/40 peer-checked/arcade:border-purple-900"
                            >
                            ...
                            <label
                                htmlFor="advanced"
                                className="w-full p-3 rounded-md border border-solid border-gray-300 peer-checked/advanced:bg-purple-100/40 peer-checked/advanced:border-purple-900"
                            >
                                <div className="flex items-start rounded-md gap-4">
                                    <img
                                        src={advancedIcon}
                            ...
                            <label
                                htmlFor="pro"
                                className="w-full p-3 rounded-md border border-solid border-gray-300 peer-checked/pro:bg-purple-100/40 peer-checked/pro:border-purple-900"
                            >
                                <div className="flex items-start rounded-md gap-4">
                                    <img
                                        src={proIcon}
                            ...
                            <div className="flex justify-center gap-4 p-3 bg-gray-400/5 w-full rounded-md">
                                <input
                                    type="checkbox"
